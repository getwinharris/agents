 ...
 * public @bapX/runtime entry — they're an implementation detail of how prompt(),
...
/**
 * Convert pi-ai's `Usage` into Bapx's public `PromptUsage`. The shapes are
 * structurally identical today, but going through this normalizer keeps
 * Bapx's public types decoupled from pi-ai's so future divergence in
