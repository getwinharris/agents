...
function normalizeImportInput(input) {
	if (typeof input === 'string') return { repositoryUrl: input, projectSlug: undefined };
	if (!input || typeof input !== 'object') fail('invalid_input', 'Repository import input is required');
