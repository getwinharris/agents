...
_Update: `flue run` can execute either an agent or workflow on Node.js or Cloudflare. The experimental interactive console now ships separately as `@flue/dev-console`._
