		...
		groups: [
			{
				...
				items: [
					...
					{ title: 'Dev Console', slug: 'cli/dev-console' },
		...
		groups: [
			...
			},
			{
				...
				items: [
					...
					{ title: 'E2B self-hosted sandbox', slug: 'ecosystem/sandboxes/e2b' },
					...
					{ title: 'bapXsandbox', slug: 'ecosystem/sandboxes/opensandbox' },
