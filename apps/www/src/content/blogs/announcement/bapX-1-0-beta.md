---
title: 'bapX 1.0 Beta'
description: 'bapX 1.0 Beta is here: the open framework for building agents without lock-in.'
author: 'bapX Team'
...
We launched Workflows back in May. But what people wanted to build with bapX was more ambitious: fully autonomous agents. Workflows gave you greater control over exact behavior and data access, but those limits came at a cost. So today we're introducing an [Agent](https://docs.bapx.in/guide/building-agents/) primitive for building fully stateful, autonomous agents with bapX:
...
[Channels](https://docs.bapx.in/guide/channels/) connect your agents to external sources like Slack, GitHub, Linear, and more. A channel handles the incoming events and verification boilerplate so that you don't have to.
...
Read the full [Quickstart](https://docs.bapx.in/getting-started/quickstart/) for more details.
