...
| [`platform.bapx.in`](https://platform.bapx.in) | GitHub-backed account/session entry and the Platform information architecture. The current page summarizes account, pricing, connectors, API keys, MCP, and observability ownership; most of those management controls are not yet interactive.                                                            |
...
| [`admin.bapx.in`](https://admin.bapx.in)       | Authentication- and entitlement-gated bapX operating surface with wider `/root/bapx.in` authority. Confirmed public GitHub repository import is implemented; private cloning and complete customer onboarding are not.                                                                                     |
...
| [`docs.bapx.in`](https://docs.bapx.in)         | Public product, framework, CLI, runtime API, SDK, MCP, OKF, and ecosystem documentation.                                                                                                                                                                                                                   |
