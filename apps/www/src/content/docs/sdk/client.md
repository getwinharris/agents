...
| `fetch`   | `typeof fetch`   | global `fetch` | Custom HTTP implementation. Also used for Durable Streams event streaming. Point it at a [Cloudflare service binding](/guide/targets/cloudflare/#calling-a-private-agent-over-a-service-binding) to reach a private agent Worker. |
