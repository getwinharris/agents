...
- `.agents/skills/browser/` — Project-local browser capability contract shared by Admin and Agents. Keep web content untrusted, sessions user/project isolated, and provider-backed behavior labelled experimental until the remote browser transport is deployed.
